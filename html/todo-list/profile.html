...
<div class="panel-container">
    ...
    <main>
        ...
        <form action="" class="row">
                ...
                <div class="row">
                    <div class="col col-4">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control ltr" id="username" name="username" value="">
                        </div>
                    </div>
                    <div class="col col-4">
                        <div class="form-group">
                    ...
                    <div class="col col-4">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control ltr" id="phone" name="phone" value="">
                        </div>
                    </div>
                    <div class="col col-4">
                        <div class="form-group">
                            <label for="birthdate">تاریخ تولد</label>
                            <input type="text"  class="form-control ltr" id="birthdate" name="birthdate" value="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col col-3">
                <div class="form-group">
                    <label for="photo">تصویر پروفایل(128x128)</label>
                    <input type="file" accept="image/jpeg,image/png" name="photo" id="photo">
                    <img src="images/hamedmoody.jpg" class="profile-photo" id="photo_preview" alt="" width="512" height="512">
                </div>
            </div>
